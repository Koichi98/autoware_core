...
{
// The testWith*() methods are now header-inline templates on the node type (so they accept both
// rclcpp::Node and autoware::agnocast_wrapper::Node target nodes); only the constructor remains here.
