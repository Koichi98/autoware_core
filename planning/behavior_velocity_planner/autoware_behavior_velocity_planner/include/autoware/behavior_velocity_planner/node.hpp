...
private:
  ...
  AUTOWARE_POLLING_SUBSCRIBER_PTR(sensor_msgs::msg::PointCloud2) sub_no_ground_pointcloud_;
  ...
  bool processNoGroundPointCloud(const AUTOWARE_MESSAGE_SHARED_PTR(const sensor_msgs::msg::PointCloud2) msg);
